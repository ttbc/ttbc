...
function ttbc_scripts() {
    ...
    //fullPage.js
    wp_register_style('ttbc-fullPage', get_template_directory_uri() . '/css/jquery.fullPage.css', array(), '2.8.2');
    wp_register_script('ttbc-fullPage', get_template_directory_uri() . '/js/jquery.fullPage.min.js', array('jquery'), '2.8.2');

    //progressbar.js
    wp_register_script('ttbc-progressbar', get_template_directory_uri() . '/js/progressbar.min.js', array('jquery'), '1.0.1');

    // Load our main stylesheet.
    wp_register_style('ttbc-style', get_template_directory_uri() . '/css/style' . $suffix . '.css', array('ttbc-open-sans', 'ttbc-fullPage'));
